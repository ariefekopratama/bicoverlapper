...
public class Analysis {
	...
	public String[] getSimilarProfiles(int threshold, String gene) {
		...
		// TODO: m‡s f‡cil/r‡pido?: d=apply(m, 1,
		// function(x){sum(x-m["17057",])}); d=sqrt(d*d)
		exp = r.eval("d=sapply(featureNames(" + m
				+ "), function(x){      sqrt(sum((exprs(" + m + ")[x,]-exprs("
				+ m + ")[\"" + gene + "\",])*(exprs(" + m + ")[x,]-exprs(" + m
				+ ")[\"" + gene + "\",])))     })");
	 ...
	 */
	// public String limma(Integer[] group1, Integer[] group2, String
	// nameGroup1, String nameGroup2, boolean bh, double pvalue, double elevel,
