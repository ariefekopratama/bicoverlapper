...
public class Handle
{
  ...
  private Overlapper applet = null;
  
  public Handle(int ix, int iy, int il, int is, Handle[] o, Overlapper bv)
  {
    x = ix;
    y = iy;
    length = il;
  ...
  public void display() 
  {
	applet.textAlign(Overlapper.LEFT);
    ...
    applet.textAlign(Overlapper.CENTER);
