...
class HeatmapHoverControl extends FocusControl
{
     ...
     */
    public HeatmapHoverControl(Session session, String activity, 
		   String group, String expressionsGroup, String geneNamesGroup, String conditionNamesGroup, 
		   MicroGridLayout mgl, HeatmapDiagram.VerticalLineLayout2 vl2, Visualization v)
		{
...
//  -- Actions performed on VisualItems ------------------------------------
    ...
    /**
     * Checks for mouse entering, this change the layout
     * It is easier to control than to use bifocal distortion
     */
