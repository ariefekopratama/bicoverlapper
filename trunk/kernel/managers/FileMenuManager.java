...
public class FileMenuManager implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
		JFileChooser selecFile = new JFileChooser();
		selecFile.addChoosableFileFilter(new files.TRNFilter());
		selecFile.setCurrentDirectory(new File(defaultPath));
		//selecFile.setLocale(new Locale("en"));
		...
		JFileChooser selecFile = new JFileChooser();
		selecFile.addChoosableFileFilter(new files.MicroarrayFilter());
		selecFile.setCurrentDirectory(new File(defaultPath));
		//selecFile.setLocale(new Locale("en"));
		int returnval = selecFile.showDialog(
	...
	if(returnval == JFileChooser.APPROVE_OPTION) {
				...
				&& ventana.isActiveWorkDesktop())
		{
			...
			if(returnval == JFileChooser.APPROVE_OPTION){
				...
				configuration.ConfigFileHandler.loadConfiguration(sesion,fichero);
			}			
		}
				...
				&& ventana.isActiveWorkDesktop())
		{
			...
			if(returnval == JFileChooser.APPROVE_OPTION){
				File fichero = selecFile.getSelectedFile();
				configuration.ConfigFileHandler.saveConfiguration(config, fichero);
			}			
		}	
