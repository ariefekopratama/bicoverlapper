...
import diagrams.BiclusVisDiagram;
import diagrams.BubblesDiagram;
import diagrams.HeatmapDiagram;
import diagrams.ParallelCoordinatesDiagram;
import diagrams.TRNDiagram;
...
//	Atributos para compartir de bicluster
	...
	//private TRNSelection selectedTRNGenes=null;
	...
	public void setConfig(ConfigurationHandler config){
		...
		for(int i = 0; i < config.getSizeConfig(); i++){
			...
			ConfigurationWindow configVentana = config.getWindowConfiguration(i);
			...
			case kernel.Configuration.PARALLEL_COORDINATES_ID:
				...
				break;
			case kernel.Configuration.HEATMAP_ID:
				...
				break;
			case kernel.Configuration.TRN_ID:
				...
				break;
			case kernel.Configuration.BUBBLE_MAP_ID:
				...
				break;
			case kernel.Configuration.OVERLAPPER_ID:
				BiclusVisDiagram panelO = new BiclusVisDiagram(this, dim);
	...
	*/
	public ConfigurationHandler getConfig(){
		...
		for(int i = 0; i < ventanas.size(); i++){
			...
			ConfigurationWindow configVentana = new ConfigurationWindow(ventana.getId(), ventana.getTitle(),
	 ...
	 */
	public LinkedList getSelectedGenesBicluster() 
	{
	 ...
	 */
	public LinkedList getSelectedConditionsBicluster() 
	{
	...
	/*TRNSelection getSelectedTRNGenes() {
		return selectedTRNGenes;
	}

	void setSelectedTRNGenes(TRNSelection selectedTRNGenes) {
		this.selectedTRNGenes = selectedTRNGenes;
		this.update("Bubble");
		this.update("Heatmap");
		}
	 */
	 ...
	 */
	boolean areMicroarraDataLoaded() {
