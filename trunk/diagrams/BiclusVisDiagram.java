 ...
 *
 */
public class BiclusVisDiagram extends Diagram
	{
private static final long serialVersionUID = 1L;
	 ...
	 */
	public BiclusVisDiagram(Session session, Dimension dim)
		{
		...
		paleta[BiclusVisDiagram.selectionColor]=sesion.getSelectionColor();
		paleta[BiclusVisDiagram.searchColor]=sesion.getSearchColor();
		paleta[BiclusVisDiagram.hoverColor]=sesion.getHoverColor();
		paleta[BiclusVisDiagram.bicColor1]=sesion.getBicSet1();
		paleta[BiclusVisDiagram.bicColor2]=sesion.getBicSet2();
		paleta[BiclusVisDiagram.bicColor3]=sesion.getBicSet3();
		paleta[BiclusVisDiagram.geneLabelColor]=new Color(195, 250, 190, 255);
		paleta[BiclusVisDiagram.conditionLabelColor]=new Color(165, 175, 250, 255);
	...
	private void addButtons(JToolBar toolBar) 
	    ...
	    //play-pause
	    button = makeNavigationButton("images/Pause24.gif", "pause",
	                                  "Pause simulation",
	                                  "Pause");
	    toolBar.add(button);

	    //overview
	    tb = makeNavigationToggleButton("images/Zoom24.gif", "overview",
	  	                                  "Show overview",
	                                  "Overview", false);
	    toolBar.add(tb);
	    ...
	    //first button
	    button = makeNavigationButton("images/ZoomOut24.gif", "zoom out",
	                                  "Zoom Out",
	                                  "Zoom Out");
	    toolBar.add(button);
		   
	    //first button
	    button = makeNavigationButton("images/ZoomIn24.gif", "zoom in",
	                                  "Zoom In",
	                                  "Zoom In");
	    toolBar.add(button);
	    ...
	    //first button
	    button = makeNavigationButton("images/radial.gif", "change model",
	                                  "change edge model",
	                                  "Change to radial model");
	    toolBar.add(button);

	    //show labels
	    tb = makeNavigationToggleButton("images/names.gif", "labels",
	  	                                  "Show names",
	                                  "Names", false);
	    toolBar.add(tb);

	    //relative label size
	    button = makeNavigationButton("images/absoluteSize.gif", "absolute label size",
                  "Absolute label size",
            	  "Name size");
	    toolBar.add(button);

	    //decrease label size
	    button = makeNavigationButton("images/namesMinus.gif", "labels minus",
	                                  "Decrease name size",
	                                  "Names minus");
	    toolBar.add(button);

	    //increase label size
	    button = makeNavigationButton("images/namesPlus.gif", "labels plus",
	                                  "Increase name size",
	                                  "Names plus");
	    toolBar.add(button);

	    //decrease Threshold
	    button = makeNavigationButton("images/Down24.gif", "decrease threshold",
	                                  "Decrease threshold",
	                                  "Decrease threshold");
	    toolBar.add(button);
	    
	    //increase Threshold
	    button = makeNavigationButton("images/Up24.gif", "increase threshold",
	                                  "Increase threshold",
	                                  "Increase threshold");
	    toolBar.add(button);

	    //show hulls
	    button = makeNavigationButton("images/withoutHull.png", "draw hulls",
	  	                                  "Hide zones",
	                                  "Draw hulls");
	    toolBar.add(button);
	    
	    //	  	first button
	    tb = makeNavigationToggleButton("images/arc3.png", "draw arcs",
	                                  "Draw nodes as chart pies",
	                                  "Draw arcs", false);
	    toolBar.add(tb);

	    //	  	first button
	    button = makeNavigationButton("images/shrink.png", "shrink",
	                                  "Decrease cluster size",
	                                  "Shrink");
	    toolBar.add(button);
	    
	    //	  	first button
	    button = makeNavigationButton("images/expand.png", "expand",
	                                  "Increase cluster size",
	                                  "Expand");
	    toolBar.add(button);
		
	    //	  	first button
	    button = makeNavigationButton("images/repulse.png", "repulse",
	                                  "Increase repulsion",
	                                  "Repulse");
	    toolBar.add(button);
		
	    //	  	first button
	    button = makeNavigationButton("images/attract.png", "attract",
	                                  "Decrease repulsion",
	                                  "Attract");
	    toolBar.add(button);

	    //	  	first button
	    tb = makeNavigationToggleButton("images/sizeGlyphs.png", "relative size",
	                                  "Change to relative size",
	                                  "Node Size", false);
	    toolBar.add(tb);

	    tb = makeNavigationToggleButton("images/hideEdges.png", "hide edges",
		                "Hide Edges",
		                "Hide Edges", true);
		toolBar.add(tb);
		tb = makeNavigationToggleButton("images/hideNodes.png", "hide nodes",
		        "Hide nodes",
		        "Hide Nodes", false);
		toolBar.add(tb);
	    
		//	  	first button
	    button = makeNavigationButton("images/config.gif", "color",
	                                  "color configuration",
	                                  "Color");
	    toolBar.add(button);

	    //	  	first button
	    button = makeNavigationButton("images/export.png", "export",
	                                  "Export image",
	                                  "Export");
	    toolBar.add(button);
...
*/
	...
	public int getId()
		{
		return kernel.Configuration.OVERLAPPER_ID;
		}
	...
	public void endConfig(){
		sesion.setSelectionColor(paleta[BiclusVisDiagram.selectionColor]);
		sesion.setSearchColor(paleta[BiclusVisDiagram.searchColor]);
		sesion.setHoverColor(paleta[BiclusVisDiagram.hoverColor]);
		sesion.setBicSet1Color(new Color(paleta[BiclusVisDiagram.bicColor1].getRed(), paleta[BiclusVisDiagram.bicColor1].getGreen(), paleta[BiclusVisDiagram.bicColor1].getBlue(),100));
		sesion.setBicSet2Color(new Color(paleta[BiclusVisDiagram.bicColor2].getRed(), paleta[BiclusVisDiagram.bicColor2].getGreen(), paleta[BiclusVisDiagram.bicColor2].getBlue(),100));
		sesion.setBicSet3Color(new Color(paleta[BiclusVisDiagram.bicColor3].getRed(), paleta[BiclusVisDiagram.bicColor3].getGreen(), paleta[BiclusVisDiagram.bicColor3].getBlue(),100));
