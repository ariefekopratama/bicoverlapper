...
import diagrams.ExpressionRenderer;
...
class MicroGridDistortion extends Layout {
    ...
    public void run(double frac) {
    	//System.out.println("************ Distortion2,run(frac)");
    	double t1=System.currentTimeMillis();
        Rectangle2D bounds = getLayoutBounds();
        Point2D anchor = correct(m_anchor, bounds);
       // if(anchor!=null)	System.out.println("Corre este, con ANCHOR corregido="+anchor.getX()+", "+anchor.getY());
       // if(m_anchor!=null)	System.out.println("anchor original "+m_anchor.getX()+", "+m_anchor.getY());
       // System.out.println("y LAYOUT="+bounds.getX()+", "+bounds.getY());
      ...
      //  System.out.println("Contiene: "+bounds.contains(anchor));
