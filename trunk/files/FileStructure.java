...
public class FileStructure implements GenericFileStructure
	...
	/**
	 * @see files.GenericFileStructure
	 */
	...
	public LinkedList<String> readRow(int row)
		...
		while(!fin)
			...
			}catch(Exception e){System.err.println("Error en FileStructure.leerFila: "+e.getMessage());}
	...
	/**
	 * @see files.GenericFileStructure.write
	 */
	public void write(String fich, int row, int column, String value)
		...
		}catch(Exception e){System.err.println("Error en FileStructure.escribir: "+e.getMessage());}
		}
