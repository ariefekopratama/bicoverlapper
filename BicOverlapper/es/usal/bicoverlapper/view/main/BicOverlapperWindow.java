...
public class BicOverlapperWindow extends JFrame {
					...
					public void tabClosed(JTabbedPane tabbedPane,
						...
						if (indexClosing != 0) {
							...
							desktop.putClientProperty(
									LafWidget.TABBED_PANE_PREVIEW_PAINTER, null);
						}
	...
	private JMenuBar crearMenu(Configuration config) {
		...
		JMenuItem downloadAEmenu = new JMenuItem("Download AE experiment");
		...
		JMenuItem fileMenuOpenLastProject = new JMenuItem(
