...
public class MicroarrayLoadProgressMonitor extends JPanel implements ActionListener,
...
private MicroarrayData.LoadTask task;  //  @jve:decl-index=0:
private JFrame frame;
private JButton closeButton;

public MicroarrayData.LoadTask getTask() {
	return task;
}


public void setTask(MicroarrayData.LoadTask task) {
	this.task = task;
}
...
public void run()
	...
	progressMonitor = new ProgressMonitor(MicroarrayLoadProgressMonitor.this,
			 "Reading metadata",
			 "Loading Microarray...", 0, 100);
	progressMonitor.setProgress(0);
	task.addPropertyChangeListener(MicroarrayLoadProgressMonitor.this);
	
	//JInternalFrame frame = new JInternalFrame("Loading Microarray data matrix");
